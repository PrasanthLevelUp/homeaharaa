...
public class SweetPage extends TestBase {

	static WebDriver driver;

	SeleniumUtils seleutils = new SeleniumUtils();

	public SweetPage(WebDriver ldriver) {
		driver = ldriver;
		...
		for (int i = 0; i < pages.size(); i++) {
			...
			for (int j = 0; j < itemheading.size(); j++) {
				...
				HashMap<Object, Object> itemdetails = CommonUtils.readjsondata(
						System.getProperty("user.dir") + "/src/main/resources/itempricedetailsjsonfiles/SWEETS.json",
